...
-(void)updateFrame {
    ...
    NSInteger rightMargin = 16;
    NSInteger buttonHeight = 44;
    self.leftButton.titleLabel.font = [UIFont systemFontOfSize:15];
    self.rightButton.titleLabel.font = [UIFont systemFontOfSize:15];
    [self.leftButton sizeToFit];
    [self.rightButton sizeToFit];
    NSInteger leftButtonWidth = self.leftButton.width;
    NSInteger rightButtonWidth = self.rightButton.width;
    ...
    self.rightButton.frame = CGRectMake(kWRScreenWidth - rightButtonWidth - rightMargin, top, rightButtonWidth, buttonHeight);
