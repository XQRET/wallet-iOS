...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if (![[NSUserDefaults standardUserDefaults] objectForKey:@"currencies"]) {
        // 设置默认货币
        [[NSUserDefaults standardUserDefaults] setObject:@"CNY" forKey:@"currencies"];
    }
    
    // 新用户没有purseToken
//    if (![[NSUserDefaults standardUserDefaults] objectForKey:@"purseToken"]) {
...
//        [_window.rootViewController presentViewController:nav animated:NO completion:nil];
//    }
